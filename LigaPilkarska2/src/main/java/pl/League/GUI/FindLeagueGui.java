...
public class FindLeagueGui extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FindLeagueGui frame = new FindLeagueGui();
	...
	public FindLeagueGui() {
		...
		JLabel addLeagueTitle = new JLabel("Find League by name ");
		...
		confirmButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				List lista=LeaguesDao.findByLeagueName(leagueNameField.getText());
				countryNameField.setText(lista.get(2).toString());
				leagueNameField.setText(lista.get(1).toString());
				sizeField.setText(lista.get(0).toString());
			}});
