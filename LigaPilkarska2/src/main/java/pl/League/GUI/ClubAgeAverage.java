...
public class ClubAgeAverage extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ClubAgeAverage frame = new ClubAgeAverage();
	...
	public ClubAgeAverage() {
		...
		JLabel clubValueTitle = new JLabel("Players age average");
		...
		confirmButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				double aqeAverage=ClubDao.ageAverage(clubNameField.getText());
				valueField.setText(Double.toString(aqeAverage));
			}});
